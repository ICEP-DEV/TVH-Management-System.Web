  ...
  return (
    <div style={{ background: 'linear-gradient(to right, #3f87a6, #ebf8e1, #f69d3c)', color: 'black', minHeight: '100vh' }}>
      ...
      <div className="container mt-4">
        ...
        <h5><p className="text-muted">See all upcoming hackathons in a single view.</p></h5>
      ...
      {/* Footer */}
      <footer className="text-center py-4" style={{ backgroundColor: 'rgba(0, 0, 0, 0.9)', color: 'black' }}>
        <div className="mb-2">
        ...
        <div className=" mt-3 text-dark">📧 support@hacktrack.com | ☎ +27 (71) 376-6731</div>
