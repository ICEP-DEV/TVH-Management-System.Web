...
const Notifications = () => {
  ...
  return (
    <div style={{ background: 'linear-gradient(to right, #3f87a6, #ebf8e1, #f69d3c)', color: 'black', minHeight: '100vh' }}>
        {/* Back Button */}
      ...
      <div className="container mt-5">
        ...
        {notifications.map((note, index) => (
          <div className="notification-card mb-3 p-4 rounded" key={index}>
            <h5>{note.title}</h5>
            <p>{note.message}</p>
      ...
      <footer className="text-center py-4 mt-5" style={{ backgroundColor: 'rgba(0, 0, 0, 0.9)', color: '#ccc' }}>
        <div className="mb-2">
          <a href="facebook.com" className="text-dark me-3"><i className="bi bi-facebook"></i></a>
          <a href="twitter.com" className="text-dark me-3"><i className="bi bi-twitter"></i></a>
          <a href="linkedin.com" className="text-dark"><i className="bi bi-linkedin"></i></a>
        </div>
