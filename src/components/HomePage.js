  ...
  return (
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="container mt-4 mb-5">
        ...
        <h5>Your one-stop hub for hackathon discovery and management.</h5>
      </div>
      ...
      <footer className="mt-5">
        <div className="social-icons mb-2">
          <a href="facebook.com" title="Facebook" className="text-dark me-3"><i className="bi bi-facebook"></i></a>
          <a href="twitter.com" title="Twitter" className="text-dark me-3"><i className="bi bi-twitter"></i></a>
          <a href="linkedin.com" title="LinkedIn" className="text-dark"><i className="bi bi-linkedin"></i></a>
        </div>
        <Link to="#top" className="text-dark me-3">Back to Top ↑</Link>
